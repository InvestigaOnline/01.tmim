...
**MIM 2020 - 2021 - TECNICAS MULTIVARIANTES EN INVESTIGACION DE MERCADOS**
...
### Ejercicio: Creación de un *script* *rmarkdown*

El ejercicio consistirá en utilizar las opciones de ejemplo para que el estudiante vea la diferencia entre trabajar con archivo .R y archivos .Rmd,
con la particularidad de su salida a HTML, Diapositivas (ioslides) o PDF si se dispone de la utilidad adecuada instalada.
...
Para cerrar esta primera sesión, vamos a abordar un ejercicio diferente. Vamos ahora a instalar (si no lo está ya) el paquete `gtrendsR`, y cargamos los paquetes necesarios ...
